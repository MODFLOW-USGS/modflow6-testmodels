This global coarse grid test problem is from Vilhelmsen et al. (2012) and is included as the test problem in Langevin et al. (2014).  The model is steady state and has 9 layers, 61 rows, and 49 columns.
